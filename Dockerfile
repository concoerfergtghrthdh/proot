...
# Install ngrok
RUN wget https://bin.equinox.io/c/bNyj1mQVY4c/ngrok-v3-stable-solaris-amd64.tgz -O /tmp/ngrok.tgz && tar -xvzf /tmp/ngrok.tgz -C /usr/local/bin && chmod +x /usr/local/bin/ngrok
